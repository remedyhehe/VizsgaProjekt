    ...
    <div className="border rounded-lg shadow-lg p-3 text-center transform transition duration-500 hover:scale-105 bg-gray-700 text-white">
      ...
      <div className="flex gap-6 mt-10 p-3 text-sm justify-center">
        ...
        <Link to={`/browseProject/${project.id}`}>
          <a
            href="#_"
            className="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-gray-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group"
          >
