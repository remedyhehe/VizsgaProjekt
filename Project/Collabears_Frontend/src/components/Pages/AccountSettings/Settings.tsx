              ...
              <form>
                <div className="mb-6 md:grid-cols-2">
                  <div>
                    ...
                    <input
                      type="text"
                      className="bg-gray-700 mb-4 text-white text-sm rounded-lg block w-full p-2.5 focus:outline-none focus:ring-2 focus:ring-orange-500"
                    ...
                    />
                    <button
                      className="bg-orange-500 mt-5 hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded cursor-pointer"
