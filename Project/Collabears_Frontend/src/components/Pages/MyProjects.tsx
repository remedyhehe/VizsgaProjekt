...
const MyProjects = () => {
  ...
  const fetchProjects = async (token: string) => {
    try {
      ...
      if (result.status) {
        setProjects(result.data); // Set the projects for the current user
      } else {
        ...
        {loading ? (
          ...
          <div className="text-center mt-20 flex flex-col items-center space-y-6 px-4">
            ...
            <p className="text-gray-500 max-w-md">
              To view your projects, please log in to your account. Once you're
              logged in, you'll see your saved and favorite projects here.
            </p>
          </div>
        ) : (
          <>
                ...
                <li className="inline-flex items-center">
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 20 20"
                    >
                      <path d="m19.707 9.293-2-2-7-7a1 1 0 0 0-1.414 0l-7 7-2 2a1 1 0 0 0 1.414 1.414L2 10.414V18a2 2 0 0 0 2 2h3a1 1 0 0 0 1-1v-4a1 1 0 1 1 1-1h2a1 1 0 1 1 1 1h3a2 2 0 0 0 2-2v-7.586l.293.293a1 1 0 0 0 1.414-1.414Z" />
                    </svg>
                    Home
                  </a>
                </li>
