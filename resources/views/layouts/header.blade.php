...
<body class="">
    ...
    <nav class="bg-gray-800 text-white sticky top-0 z-50 px-5 py-4 flex justify-between items-center">
        ...
        <img class="h-12" src="{{ asset('img/maci.png') }}" alt="Logo">
        ...
        <div class="hidden lg:inline-block lg:ml-auto text-white">
            ...
            <div id="userDropdown"
                class="hidden absolute right-5 mt-2 w-75 bg-white text-black rounded-lg shadow-lg p-4 z-10">
                
                <a href="/login"><button type="submit" class="w-full bg-orange-500 text-white py-2 rounded-md">Login</button></a>
        ...
        <nav
            ...
            <div class="flex items-center mb-8">
                <a class="mr-auto text-3xl font-bold leading-none" href="#">
                    <img class="h-12" src="{{ asset('img/maci.png') }}" alt="">
