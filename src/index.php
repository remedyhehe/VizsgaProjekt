...
<div class="bg-gray-50 min-h-screen">
  ...
  <div class="relative container mx-auto px-6 text-center">
    ...
    <p class="text-lg mb-6">Indítsd el a saját projektedet, vagy csatlakozz másokhoz, hogy együtt valósítsatok meg nagyszerű dolgokat.</p>
    <div class="flex justify-center space-x-4">
      <a href="#" class="px-6 py-3 bg-orange-500 text-white font-medium rounded-lg shadow-md hover:bg-orange-700"><i class="fa-solid fa-folder-plus"></i> Projekt létrehozása</a>
      <a href="./projects.php" class="px-6 py-3 bg-transparent border text-white font-medium rounded-lg hover:bg-orange-500 hover:text-white">Böngészés projektek között</a>
    </div>
  </div>
</section>
<!-- Információ -->
<section class="bg-white py-16">
    ...
    <div class="text-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="group bg-gray-100 p-6 rounded-lg shadow-md">
          <h3 class="text-lg font-semibold mb-3 text-orange-500 group-hover:stroke-white "><i class="fa-solid fa-bolt"></i> Gyors toborzás</h3>
          <p class="text-gray-600 group-hover:text-orange-500">Találd meg gyorsan és egyszerűen a megfelelő csapattagokat a projekthez.</p>
        </div>
        <div class="group bg-gray-100 p-6 rounded-lg shadow-md">
          <h3 class="text-lg font-semibold mb-3 text-orange-500"><i class="fa-solid fa-magnifying-glass"></i> Egyszerű keresés</h3>
          <p class="text-gray-600 group-hover:text-orange-500">Szűrj projektek és készségek alapján, hogy könnyen megtaláld, amit keresel.</p>
        </div>
        <div class="group bg-gray-100 p-6 rounded-lg shadow-md">
          <h3 class="text-lg font-semibold mb-3 text-orange-500"><i class="fa-solid fa-earth-europe"></i> Széles közösség</h3>
          <p class="text-gray-600 group-hover:text-orange-500">Csatlakozz egy aktív és inspiráló közösséghez, ahol mindenki együtt dolgozik a sikerért.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="py-16">
    <div class="container mx-auto px-6">
      <h2 class="text-2xl font-bold text-gray-800 text-center mb-8">Kiemelt Projektek <i class="fa-solid fa-star"></i></h2>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="border rounded-lg shadow-lg p-3 text-center">
              ...
              <div class="flex gap-6 mt-10 p-3 text-sm justify-center">
                ...
                <button class="bg-orange-500 p-3 rounded text-white hover:bg-gray-700 font-semibold">Részletek</button>
  ...
  <section class="py-16">
    <div class="container mx-auto px-6">
      <h2 class="text-2xl font-bold text-gray-800 text-center mb-8">Felhasználói vélemények <i class="fa-solid fa-comment"></i></h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="bg-white rounded-lg shadow-lg p-6">
          <p class="text-gray-600 italic">"A platformnak köszönhetően találtam meg a tökéletes csapatot az alkalmazásfejlesztéshez!"</p>
          <p class="text-gray-800 mt-4 font-bold">- Gergő</p>
        </div>
        <!-- Felhasználói Vélemények -->
        <div class="bg-white rounded-lg shadow-lg p-6">
          <p class="text-gray-600 italic">"Egyszerű és gyors módja a projektindításnak, fantasztikus közösség."</p>
