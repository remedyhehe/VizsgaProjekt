        ...
        <div class="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
            <div class="relative flex h-16 items-center justify-between">
                <div class="absolute inset-y-0 left-0 flex items-center">
                    <img class="h-24" src="../img/maci.png" alt="">
                ...
                <div class="flex flex-1 items-center justify-center">
                    <div class="hidden sm:block">
                        <div class="flex space-x-4">
                            ...
                            <a href="#"
                                class="rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-gray-700 hover:text-white"><i
        ...
        <div class="lg:hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pb-3 pt-2">
                ...
                <a href="./index.php" class="block rounded-md bg-gray-900 px-3 py-2 font-medium text-white"
                    aria-current="page"><i class="fa-solid fa-house"></i> Főoldal</a>
                <a href="#"
                    class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-gray-700 hover:text-white"><i
                        class="fa-solid fa-play"></i> Projekt indítás</a>
                <a href="#"
                    class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-gray-700 hover:text-white"><i
                        class="fa-solid fa-plus"></i> Sajtát Projektek</a>
                <a href="./projects.php"
                    class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-gray-700 hover:text-white"><i
                        class="fa-solid fa-globe"></i> Böngészés</a>
            </div>
